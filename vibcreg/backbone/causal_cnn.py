...
class CausalCNNEncoder(torch.nn.Module):
    ...
    def __init__(self, in_channels=1, channels=40, depth=10, reduced_size=160,
                 out_channels=320, kernel_size=3,
                 pool_type='combined2', **kwargs):
        ...
        self.last_channels_enc = reduced_size
        self.pool_type = pool_type
        if pool_type == 'combined2':
            self.linear = nn.Linear(reduced_size, 1)

    def forward(self, x, return_concat_combined=True, one_sided_partial_mask=0., **kwargs):
        out = self.network(x)
...
if __name__ == '__main__':
    ...
    # model
    model = CausalCNNEncoder(in_channels=1,
                             channels=40,
                             depth=10,
                             reduced_size=160,
                             out_channels=320,
