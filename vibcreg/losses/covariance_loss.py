...
class VIbCRegCovLoss(nn.Module):
    ...
    def forward(self, z1: Tensor, z2: Tensor) -> Tensor:
        ...
        fxf_cov_z1[ind[0], ind[1]] = torch.zeros(fxf_cov_z1.shape[0], device=norm_z1.get_device())
        fxf_cov_z2[ind[0], ind[1]] = torch.zeros(fxf_cov_z2.shape[0], device=norm_z1.get_device())
